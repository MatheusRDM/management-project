...
SPEC_LIMITS = {
    "DER-PR": {
        # ES-PA 21/23 — DER/PR
        "abrasao_la":          {"max": 40, "unit": "%", "ref": "DNER-ME 035/98"},
        "equivalente_areia":   {"min": 55, "unit": "%", "ref": "DNER-ME 054/97"},
    ...
    "DNIT": {
        # DNIT 031/2006-ES
        "abrasao_la":          {"max": 50, "unit": "%", "ref": "DNER-ME 035/98"},
        "equivalente_areia":   {"min": 55, "unit": "%", "ref": "DNER-ME 054/97"},
        "durabilidade_graudo": {"max": 18, "unit": "%", "ref": "DNER-ME 089"},
        "durabilidade_miudo":  {"max": 18, "unit": "%", "ref": "DNER-ME 089"},
        "volume_vazios":       {"min": 3, "max": 5, "unit": "%"},
    ...
    "DEINFRA": {
        # DEINFRA-SC ES-P 05/16 — mais restritivo
        "abrasao_la":          {"max": 30, "unit": "%", "ref": "DNER-ME 035/98"},
        "equivalente_areia":   {"min": 60, "unit": "%", "ref": "DNER-ME 054/97"},
        "durabilidade_graudo": {"max": 18, "unit": "%", "ref": "DNER-ME 089"},
        "durabilidade_miudo":  {"max": 18, "unit": "%", "ref": "DNER-ME 089"},
